...
export class MinerFactory {
  ...
  static from_subnet(subnet: string): MinerFactory;
  static fromRange(range: string): MinerFactory;
  static from_range(range: string): MinerFactory;
  static fromOctets(octet1: string | number, octet2: string | number, octet3: string | number, octet4: string | number): MinerFactory;
  static from_octets(octet1: string | number, octet2: string | number, octet3: string | number, octet4: string | number): MinerFactory;
  withSubnet(subnet: string): this;
  with_subnet(subnet: string): this;
  withRange(range: string): this;
  with_range(range: string): this;
  withOctets(octet1: string | number, octet2: string | number, octet3: string | number, octet4: string | number): this;
  with_octets(octet1: string | number, octet2: string | number, octet3: string | number, octet4: string | number): this;
  withConcurrentLimit(concurrent: number): this;
  with_concurrent_limit(concurrent: number): this;
  getMiner(ip: string): Promise<Miner | null>;
  get_miner(ip: string): Promise<Miner | null>;
  scan(): Promise<Miner[]>;
}
...
export class Miner {
  ...
  readonly supports_set_fault_light: boolean;
  readonly supportsSetPowerLimit: boolean;
  readonly supports_set_power_limit: boolean;
  readonly supportsSetTuningPercent: boolean;
  readonly supports_set_tuning_percent: boolean;
  readonly supportsRestart: boolean;
  readonly supports_restart: boolean;
  ...
  get_data(): Promise<MinerData>;
  getHashrate(): Promise<HashRate | null>;
  get_hashrate(): Promise<HashRate | null>;
  getExpectedHashrate(): Promise<HashRate | null>;
  get_expected_hashrate(): Promise<HashRate | null>;
  getFans(): Promise<FanData[]>;
  get_fans(): Promise<FanData[]>;
  getPsuFans(): Promise<FanData[]>;
  get_psu_fans(): Promise<FanData[]>;
  getPools(): Promise<PoolGroupData[]>;
  get_pools(): Promise<PoolGroupData[]>;
  getMessages(): Promise<MinerMessage[]>;
  get_messages(): Promise<MinerMessage[]>;
  getDeviceInfo(): Promise<DeviceInfo>;
  get_device_info(): Promise<DeviceInfo>;
  getMac(): Promise<string | null>;
  get_mac(): Promise<string | null>;
  getSerialNumber(): Promise<string | null>;
  get_serial_number(): Promise<string | null>;
  getHostname(): Promise<string | null>;
  get_hostname(): Promise<string | null>;
  getApiVersion(): Promise<string | null>;
  get_api_version(): Promise<string | null>;
  getFirmwareVersion(): Promise<string | null>;
  get_firmware_version(): Promise<string | null>;
  getWattage(): Promise<number | null>;
  get_wattage(): Promise<number | null>;
  getFluidTemperature(): Promise<number | null>;
  get_fluid_temperature(): Promise<number | null>;
  getOutletFluidTemperature(): Promise<number | null>;
  get_outlet_fluid_temperature(): Promise<number | null>;
  getTuningPercent(): Promise<number | null>;
  get_tuning_percent(): Promise<number | null>;
  getIsMining(): Promise<boolean>;
  get_is_mining(): Promise<boolean>;
  restart(): Promise<boolean>;
  pause(): Promise<boolean>;
  resume(): Promise<boolean>;
  setFaultLight(fault: boolean): Promise<boolean>;
  set_fault_light(fault: boolean): Promise<boolean>;
  setPowerLimit(watts: number): Promise<boolean>;
  set_power_limit(watts: number): Promise<boolean>;
  setTuningPercent(percent: number): Promise<boolean>;
  set_tuning_percent(percent: number): Promise<boolean>;
}
